...
```bash
python3 /Users/denny/.gemini/config/skills/adr-rpi/scripts/adr_index.py docs/adrs             # rewrite INDEX.md
python3 /Users/denny/.gemini/config/skills/adr-rpi/scripts/adr_index.py docs/adrs --check     # CI: fail if stale
python3 /Users/denny/.gemini/config/skills/adr-rpi/scripts/adr_chain.py docs/adrs --validate  # check the links
```
